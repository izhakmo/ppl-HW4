...
const parseBindingValues = (bind : [Sexp[],Sexp]): Result<BindingValues> =>
    safe2((vds : VarDecl[], vals: CExp) => makeOk(makeBindingValues(vds,vals)))
        (mapResult((dekel => parseVarDecl(dekel)),bind[0] ) ,parseL5CExp(bind[1]) )
